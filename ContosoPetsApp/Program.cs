...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            if (petCount < maxPets)
            {
                Console.WriteLine($"You have {petCount} pets in the system. You can add up to {maxPets} pets.");
            }
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                if (petCount < maxPets)
                {
                    Console.WriteLine("Do you want to add info for another pet? (y/n)");
                    do
                    {
                        readResult = Console.ReadLine();
                        if (readResult != null)
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 2] == "Age: ?")
                {
                    ...
                    while (!validInput)
                    {
                        ...
                        {
                            animalAge = readResult;
                            validInput = int.TryParse(animalAge, out int petAge);
                            if (!validInput)
                            {
